...
function renderResult(result) {
    ...
    for (const [key, val] of Object.entries(p)) {
        if (preferred.includes(key) || key === "agentverseSelected")
            continue;
        if (val == null || val === "")
            continue;
